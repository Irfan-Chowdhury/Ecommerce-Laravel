        ...
        <div class="container">
          <div class="row">
            <div class="col-sm-12">
              ...
              {{-- Navbar এ Cart- এ টোটাল কয়টা সেটা দেখানোর জন্য ।  --}}
              ...
              <div class="top-right pull-right">
                <div id="top-links" class="nav pull-right">
                  <ul class="list-inline">
                    ...
                    @else
                        <li class="dropdown account"><a href="#" title="My Account" class="  dropdown-toggle" data-toggle="dropdown"> <img src="{{App\Helpers\ImageHelper::getUserImage(Auth::user()->id)}}" height="20px" width="30px">  <span>{{ Auth::user()->first_name.' '.Auth::user()->last_name }}</span> <span class="caret"></span></a>
                          <ul class="dropdown-menu dropdown-menu-right">
                  ...
                  <form action="{{route('search')}}" method="get">
                    <div class="search-box">
                      <input class="input-text" placeholder="Search By Products.." name="search" type="text">
        ...
        <div class="header-inner">
          ...
          <div class="col-sm-4 col-xs-12 header-middle">
            <div class="header-middle-top">
              <div id="logo"> <a href="{{ route('index') }}"><img src="image/logo.png" title="E-Commerce" alt="E-Commerce" class="img-responsive" /></a> </div>
            </div>
          </div>
          ...
          <div class="nav-inner">
            ...
            <div class="navbar-collapse">
              <ul class="main-navigation">
                ...
                <li><a href="{{ route('products') }}"  class="parent">Products</a> </li>
