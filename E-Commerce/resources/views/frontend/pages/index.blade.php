  ...
  <div class="container">
        <div class="mainbanner">
            <div id="main-banner" class="owl-carousel home-slider">
                <div class="item"> <a href="#"><img src="{{asset('image/banners/Banner-1.jpg')}}" width="1903" height="620" alt="main-banner1" class="img-responsive" /></a> </div>
                <div class="item"> <a href="#"><img src="{{asset('image/banners/Banner-2.jpg')}}" width="1903" height="620" alt="main-banner2" class="img-responsive" /></a> </div>
                <div class="item"> <a href="#"><img src="{{asset('image/banners/Banner-3.jpeg')}}" width="1903" height="620" alt="main-banner3" class="img-responsive" /></a> </div>
            </div>
        </div>
    </div>
                ...
                <div class="item">
                  <div class="product-thumb transition">
                      ...
                      @foreach ($product->images as $image)
                          @if ($i>0)
                            {{-- <div class="image product-imageblock"> <a href="product.html"><img src="{{asset('image/product-image',$product->images->image)}}" alt="lorem ippsum dolor dummy" title="lorem ippsum dolor dummy" class="img-responsive" /> </a> --}}
                            <div class="image product-imageblock"> <a href="{{route('products.show',$product->slug)}}"><img src="{{asset('image/product-image/'.$image->image)}}" alt="lorem ippsum dolor dummy" title="lorem ippsum dolor dummy" class="img-responsive" /> </a>
                          @endif
                        @php $i--; @endphp
                      @endforeach
