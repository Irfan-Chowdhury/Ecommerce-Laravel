        ...
        <div class="row">
          ...
          <div id="content" class="col-sm-9">
            ...
            <div class="grid-list-wrapper">
              ...
              <h2>Search product for <strong>{{$search}}</strong></h2>
                ...
                <div class="product-layout product-list col-xs-12">
                  <div class="product-thumb">
                    ...
                    <div class="caption product-detail">
                      <!-- Product Name -->
                      <h4 class="product-name"><a href="{{route('products.show',$product->slug)}}" title="lorem ippsum dolor dummy"> {{ $product->title }} </a> </h4>
